...
class CreateOrderForm(forms.Form):
    ...
    delivery_address = forms.CharField(required=False) # если в backend, то для формы | если в шаблоне то для браузера
    ...
    #     widget=forms.RadioSelect(), choices=[("0", False), ("1", True)], initial="card"
