...
$(document).ready(function () {
  ...
  $(document).on("click", ".add-to-cart", function (e) { // ловим событие клика, по контейнеру (тегу ссылки <a>), который содержит в себе класс add-to-cart (в catalog.html)
      ...
      var cartCount = parseInt(goodsInCartCount.text() || 0); // преобразование в число

      // Получаем id товара из атрибута data-product-id
      var product_id = $(this).data("product-id"); // data-product-id. data указывает что это js

      // Из атрибута href элемента класса add-to-cart берем ссылку на контроллер django
      ...
      $.ajax({
          ...
          success: function (data) { // data это jsonresponce от django при выполнении взаимодействия с cart (возможно cart_add)
              ...
              cartCount++; // увеличение счетчика на 1
              goodsInCartCount.text(cartCount); // отрисовка в шаблоне
